...
Consisteix en la multiplicació $c = b*A$, on A és una matriu $m \times n$, b és un vector de mida $m$ i c és un vector de mida $n$.
...
\qquad \longrightarrow \qquad
 \begin{matrix} 
 c_1 = b_1 a_{11} + b_1 a_{21} \\
 c_2 = b_2 a_{12} + b_2 a_{22} \\
 c_3 = b_3 a_{13} + b_3 a_{23} \\
 \end{matrix}
 \]
